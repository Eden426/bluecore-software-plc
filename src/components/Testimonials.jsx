  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden
      >
        <div className="absolute -left-24 top-10 h-[320px] w-[320px] rounded-full bg-[#8B5E3C]/10 blur-3xl" />
        <div className="absolute -right-28 bottom-4 h-[360px] w-[360px] rounded-full bg-[#06243f]/10 blur-3xl dark:bg-[#8B5E3C]/12" />
      </div>
      ...
      <div className="relative z-10 mx-auto min-w-0 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600 dark:text-[#FAFAFA]/75 sm:text-base sm:leading-8">
        ...
        <div className="mt-10 grid min-w-0 gap-10 lg:mt-14 lg:grid-cols-[0.78fr_1.22fr] lg:gap-14">
          ...
          >
            <div className="border-l-4 border-[#8B5E3C] pl-5 sm:pl-7">
              ...
              <p className="mt-5 text-sm leading-7 text-slate-600 dark:text-white/70 sm:text-base sm:leading-8">
            ...
            <div className="mt-7 space-y-3 pl-5 sm:pl-7">
              {descendingLines.map((widthClass, index) => (
                <motion.span
                  ...
                  className={`block h-[3px] origin-left rounded-full bg-[#8B5E3C] ${widthClass}`}
                />
              ))}
            </div>
          </motion.div>
          ...
          <div className="space-y-8">
            {testimonials.map((t, i) => (
              <motion.article
                ...
                className="group relative grid gap-4 border-t border-[#8B5E3C]/25 pt-6 sm:grid-cols-[auto_1fr] sm:gap-5"
              >
                <div
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-700 dark:text-[#FAFAFA]/78 sm:text-base sm:leading-8">
                    “{t.review}”
                  </p>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-1 text-xs font-medium text-slate-500 dark:text-[#FAFAFA]/55 sm:text-sm">
                      {t.role} · {t.company}
                    </p>
                  </div>
                </div>
