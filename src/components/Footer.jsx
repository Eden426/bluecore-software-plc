...
const socials = [
  {
    label: "WhatsApp",
    href: "https://whatsapp.com/channel/0029Vb85HmjEFeXqcitfFW0K",
    Icon: WhatsAppIcon,
    color: "hover:text-[#25D366]",
  },
  {
    label: "Telegram",
    href: "https://t.me/bluecore_software_plc",
    Icon: TelegramIcon,
  ...
  return (
    <footer className="overflow-hidden border-t border-white/10 bg-[#0F172A] text-white dark:border-white/[0.08] dark:bg-[#09090B] dark:text-[#FAFAFA]">
      <div className="mx-auto min-w-0 max-w-7xl px-3 py-9 sm:px-5 sm:py-14 lg:px-6">
        <div className="grid grid-cols-2 gap-x-5 gap-y-8 sm:grid-cols-4 sm:gap-x-6 lg:grid-cols-12 lg:gap-10">
          {/* Brand column */}
          <div className="col-span-2 min-w-0 sm:col-span-1 lg:col-span-4">
            <a href="/#home" className="inline-block rounded-md bg-white p-1 dark:bg-transparent">
              <img
                src={logo}
                ...
                loading="lazy"
                decoding="async"
                className="h-8 w-auto max-w-[82px] object-contain object-left dark:hidden sm:h-12 sm:max-w-[200px]"
              />
              <img
                src={blackLogo}
                alt="Bluecore Software PLC"
                ...
                loading="lazy"
                decoding="async"
                className="hidden h-8 w-auto max-w-[82px] object-contain object-left dark:block sm:h-12 sm:max-w-[200px]"
              />
            </a>

            <h2 className="mt-3 text-xs font-bold leading-5 text-white sm:text-sm">
              Bluecore Software PLC
            </h2>

            <p className="mt-2 max-w-full text-xs leading-5 text-slate-300 dark:text-[#FAFAFA]/78 sm:text-sm sm:leading-7 lg:max-w-sm">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-1.5 sm:mt-5 sm:gap-3">
              {socials.map(({ label, href, Icon, color }) => (
                <a
                  ...
                  aria-label={label}
                  className={`flex h-8 w-8 items-center justify-center rounded-md border border-white/15 text-slate-300 transition-colors ${color} hover:border-white/30 sm:h-9 sm:w-9 sm:rounded-lg dark:border-white/10`}
                >
          ...
          >
            <h2 className="text-xs font-bold uppercase tracking-wider text-[#8B5E3C] sm:tracking-widest">
              Quick Links
            </h2>
          ...
          <div className="col-span-2 min-w-0 sm:col-span-1 lg:col-span-3">
            ...
            <ul className="mt-3 space-y-2.5 text-xs sm:mt-4 sm:space-y-4 sm:text-sm">
              <li>
                <a
              ...
              <li>
                <a
                  ...
                  className={`flex items-start gap-1.5 sm:gap-3 ${linkClass}`}
                >
                  <TelegramIcon className="mt-0.5 h-3 w-3 shrink-0 text-[#229ED9] sm:h-4 sm:w-4" />
            ...
            <a
              href="/#contact"
              className="mt-4 inline-flex rounded-md bg-[#8B5E3C] px-2 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-[#A0694A] sm:mt-6 sm:rounded-xl sm:px-4 sm:py-2.5 sm:text-sm"
            >
              Get in touch
            </a>
          </div>
