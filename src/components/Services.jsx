...
export default function Services() {
  ...
  return (
    <section
      id="services"
      className="relative overflow-x-clip bg-white py-12 text-[#06243F] dark:bg-[#09090B] dark:text-[#FAFAFA] sm:py-16 lg:py-20"
    >
      ...
      <div className="pointer-events-none absolute inset-0 opacity-60 dark:opacity-100" aria-hidden>
        <div className="services-blob-a absolute -left-24 top-8 h-[240px] w-[240px] rounded-full bg-gradient-to-tr from-[#103759]/12 via-[#103759]/8 to-transparent blur-3xl sm:-left-32 sm:top-10 sm:h-[320px] sm:w-[320px] md:h-[380px] md:w-[380px] lg:h-[420px] lg:w-[420px] dark:from-[#2563EB]/15 dark:via-[#3B82F6]/12" />
        <div className="services-blob-b absolute -right-16 top-1/4 h-[220px] w-[220px] rounded-full bg-gradient-to-bl from-[#4460AA]/7 via-[#EAF3FF]/6 to-transparent blur-3xl sm:-right-24 sm:h-[300px] sm:w-[300px] md:h-[340px] md:w-[340px] lg:h-[380px] lg:w-[380px] dark:from-[#8B5E3C]/12 dark:via-[#c4a07a]/10" />
        <div className="services-blob-c absolute bottom-0 left-1/2 h-[220px] w-[min(100%,380px)] -translate-x-1/2 rounded-full bg-gradient-to-t from-[#103759]/7 via-[#4460AA]/4 to-transparent blur-3xl sm:w-[480px] sm:max-w-[90vw] md:h-[300px] lg:h-[360px] dark:from-[#2563EB]/12 dark:via-[#8B5E3C]/8" />
      </div>
