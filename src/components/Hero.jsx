...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative isolate w-full overflow-x-clip overflow-y-hidden bg-[#09090B] text-[#FAFAFA]"
    >
      ...
      <div className="relative z-[1] mx-auto grid min-w-0 max-w-[1480px] grid-cols-[minmax(0,1.08fr)_minmax(120px,0.72fr)] items-center gap-5 px-3 py-10 sm:grid-cols-[0.95fr_1.05fr] sm:gap-6 sm:px-6 sm:py-16 md:gap-10 md:py-20 lg:grid-cols-[0.88fr_1.12fr] lg:gap-16 lg:px-12 lg:py-24 xl:gap-24 xl:px-16 2xl:gap-28 2xl:px-20">
        ...
        <div className="order-1 flex min-w-0 items-center lg:-ml-4 lg:pl-0 xl:-ml-8 2xl:-ml-10">
          <div className="max-w-2xl border-l-2 border-[#875131] pl-2 sm:border-l-4 sm:pl-6 md:pl-7">
            {/* Badges */}
            <div className="mb-3 flex flex-wrap gap-1.5 sm:mb-7 sm:gap-3">
              {heroBadges.map(({ Icon, label }) => (
                <span
                  ...
                  role="img"
                  aria-label={label}
                  className="inline-flex rounded-lg border border-white/10 bg-white/[0.06] p-1.5 text-white ring-1 ring-white/10 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-[#8B5E3C]/60 hover:text-[#8B5E3C] sm:rounded-xl sm:p-3"
                >
            ...
            <p className="text-[8px] font-bold uppercase tracking-[0.13em] text-[#8B5E3C] sm:text-sm sm:tracking-[0.24em]">
              Smart Software. Solid Core.
            </p>

            <h1 className="mt-2 font-black leading-tight text-white sm:mt-4">
              ...
              <span className="mt-1 block text-[clamp(0.9rem,4vw,3.35rem)] text-[#8B5E3C] sm:text-[clamp(2.1rem,5vw,3.35rem)]">
                a Solid Core.
              </span>
            </h1>

            <p className="mt-3 max-w-xl text-[9px] leading-4 text-white/75 sm:mt-5 sm:text-base sm:leading-8 md:text-lg">
            ...
            <div className="mt-4 flex pl-1 sm:mt-8 sm:pl-8 md:pl-12">
              <a
                href="#contact"
                className="inline-flex min-h-8 min-w-[95px] items-center justify-center rounded-lg bg-[#875131] px-4 py-2 text-center text-[10px] font-bold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#A0694A] sm:min-h-12 sm:min-w-[220px] sm:rounded-xl sm:px-12 sm:py-3 sm:text-sm"
              >
                Contact Us
              </a>
            </div>
        ...
        <div className="order-2 flex min-w-0 items-center justify-end xl:translate-x-14 2xl:translate-x-20">
          <div className="relative w-full max-w-[155px] sm:max-w-[520px] md:max-w-[720px] lg:max-w-[900px] xl:max-w-[980px] 2xl:max-w-[1040px]">
            {/* Brown ambient glow */}
            <div
              className="pointer-events-none absolute -inset-3 -z-10 rounded-[1.5rem] opacity-70 blur-xl sm:-inset-12 sm:rounded-[3.5rem] sm:opacity-90 sm:blur-3xl"
              style={{
                background:
                  "radial-gradient(ellipse at center, rgba(135, 81, 49, 0.35), rgba(135, 81, 49, 0.15) 42%, rgba(6, 36, 63, 0.18) 64%, transparent 78%)",
              }}
              aria-hidden="true"
            />
            ...
            <div className="relative aspect-[3/4] overflow-hidden rounded-[1.35rem] sm:aspect-auto sm:h-[380px] sm:rounded-[2.75rem] md:h-[450px] lg:h-[510px] xl:h-[530px]">
              ...
              <div className="pointer-events-none absolute inset-0 z-10 rounded-[1.35rem] bg-[#8B5E3C]/18 mix-blend-screen sm:rounded-[2.75rem]" />
              ...
              <img
                ...
                className="h-full w-full rounded-[1.35rem] object-cover object-center opacity-[0.92] shadow-[0_22px_70px_rgba(139,94,60,0.18)] sm:rounded-[2.75rem]"
                style={{
                  WebkitMaskImage:
