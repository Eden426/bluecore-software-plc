...
export default function Preloader() {
  ...
  return (
    <div
      className={`fixed inset-0 z-[99999] flex items-center justify-center overflow-hidden bg-[#09090B] transition-all duration-700 ${
    ...
    >
      ...
      <div className="relative flex min-h-[430px] flex-col items-center justify-center px-6 text-center">
        {/* Circle */}
        <div
          className="pointer-events-none absolute left-1/2 top-[42%] h-64 w-64 rounded-full border-[5px] border-[#875131]/80 border-r-[#06243f] border-t-white/85 sm:h-80 sm:w-80"
        ...
        {/* Slogan */}
        <p
          className="relative z-10 mt-8 text-[10px] font-semibold uppercase tracking-[0.32em] text-white/60 sm:text-sm"
